...
export default function ModalCreatePost() {
    ...
    const handleCreatePost = () => {
        axios
            .post(`${MainAPI}/staff/create-post`, { description: description, user_id: auth.user.user_id, title: title, image_url: image },
                {
                    headers: {
    ...
    return (
        ...
        >
            <div className="create-post-content">
                ...
                <form class="row g-3">
                    <div class="mb-3">
                        <input type="email" class="form-control" placeholder="Post title" onChange={(e) => {
                            setTitle(e.target.value);
                        }} />
                    </div>
                    <div class="mb-3">
                        <input class="form-control" placeholder='Thumbnail Image URL' onChange={(e) => {
