...
import { thanhtoans, chogiaos, dagiaos, dahuy, danggiaos } from "./ListProduct";
              ...
              <div className={title === 'Chờ giao' ? 'chờ giao' : 'fade'}>
                ...
                {chogiaos.length === 0 ?
                  <div className="emptyinfo">
                    <img src={"https://firebasestorage.googleapis.com/v0/b/swp391-milkmartsystem.appspot.com/o/images%2Faccount%2Fchogiao.png?alt=media&token=8580382f-7bc6-477f-a95e-38b3a06eb189"} />
                    <p>Hiện chưa có đơn hàng nào <br />đang chờ được giao</p>
                  </div>
                  :
                  chogiaos.map((chogiao) => {
                    return (
                      <div className="eachchogiao">
                        <div className="tab-content">
                          <div key="1" className="cart-product-line d-flex ">
                            <div className="product-img">
                              <img src={chogiao.img} alt="1" />
                            </div>
                            <div className="product-info w-100">
                              <div className="item-cart-product-name">
                                {chogiao.info}
